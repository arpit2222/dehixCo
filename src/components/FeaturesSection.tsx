      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-24 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-white/60">
            DEHIX replaces the structurally inefficient talent market with a predictive, AI-driven architecture.
          </p>
        </div>

        {/* Feature 1: AI Credentials */}
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32 relative">
          ...
          <div className="order-2 lg:order-1 relative h-[400px] bg-[#120a1f]/50 backdrop-blur-md rounded-2xl border border-pink-500/20 flex items-center justify-center overflow-hidden glow-card">
            ...
            <div className="relative w-64 h-80 bg-[#160c26] border border-pink-500/30 rounded-xl shadow-[0_0_30px_rgba(236,72,153,0.2)] p-6 flex flex-col justify-between">
              <div>
                ...
                <h4 className="text-white font-mono text-sm mb-2">CREDENTIAL // ID: 8492</h4>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center border-t border-white/10 pt-3">
                  ...
                  <span className="text-xs text-pink-400 font-medium glow-text">Verified by AI Model</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs text-white/50">Confidence Score</span>
                  <span className="text-xs text-white font-mono">98.5%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h3 className="text-3xl font-bold mb-6 text-white">AI-Verified Credentials</h3>
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Self-reported resumes create adverse selection. We replace them with dynamic credentials that our neural networks verify against real-world performance data. Unforgeable proof of skill.
            </p>
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/80">Identity bound to verified past work, not claims.</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 w-5 h-5 rounded-full bg-pink-500/20 flex items-center justify-center shrink-0">
                  <div className="w-2 h-2 bg-pink-500 rounded-full glow-card" />
                </div>
                <span className="text-white/80">Deterministic performance scoring updated by continuous AI evaluation.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32 relative">
          ...
          <div>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Complex projects require cross-functional teams. Our AI-driven squad assembly engine reads verified performance data to compute and deploy optimal squads on demand.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/80">AI-assembled teams based on predictive compatibility.</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 w-5 h-5 rounded-full bg-purple-500/20 flex items-center justify-center shrink-0">
                  <div className="w-2 h-2 bg-purple-500 rounded-full glow-card" />
                </div>
                <span className="text-white/80">Automated project management and lifecycle tracking.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="relative h-[400px] bg-[#120a1f]/50 backdrop-blur-md rounded-2xl border border-purple-500/20 flex items-center justify-center p-8 glow-card">
             <div className="w-full flex flex-col gap-4">
               ...
               <div className="flex items-center gap-4 p-4 border border-purple-500/40 bg-purple-500/10 rounded-lg relative overflow-hidden shadow-[0_0_20px_rgba(168,85,247,0.2)]">
                 ...
                 <div className="w-10 h-10 rounded bg-purple-500/30 border border-purple-500/50 flex items-center justify-center text-xs font-mono text-purple-300">ENG</div>
                 <div className="flex-1">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 relative h-[400px] bg-[#120a1f]/50 backdrop-blur-md rounded-2xl border border-pink-500/20 flex items-center justify-center glow-card">
             ...
             <div className="relative w-48 h-48 flex items-center justify-center">
                {/* Concentric circles representing neural network processing */}
                ...
                <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-purple-600 text-white font-bold flex items-center justify-center rounded-full shadow-[0_0_30px_rgba(236,72,153,0.5)] z-10 glow-card text-xs">
                  AI CORE
                </div>
             </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="text-pink-400 font-mono text-sm mb-4 tracking-wider glow-text">03 // ANALYTICS LAYER</div>
            <h3 className="text-3xl font-bold mb-6 text-white">Predictive Performance Analytics</h3>
            <p className="text-white/60 text-lg leading-relaxed mb-8">
              Continuous real-time feedback loops train our AI engine. As squads deliver projects, the neural network refines its understanding of team dynamics, communication patterns, and skill synergies.
            </p>
